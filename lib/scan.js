 ...
 * @param {string} [options.home] - Override home directory (defaults to HOME/USERPROFILE)
 * @param {string} [options.cwd] - Override working directory (defaults to projectDir or process.cwd())
...
module.exports = { scan, parseFrontmatter, scanCommands, scanSkills, scanAgents, scanRules, scanDirTree };
